# FORMS ARE HARD 🙃
But everything is a form. And will continue to be a form until all the robots just talk to each other for us - then I'll be able retire. Until then, I'll keep working on forms and making them easier to implement.
