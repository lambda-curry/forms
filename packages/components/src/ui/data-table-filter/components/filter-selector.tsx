    ...
    >
      <div className="flex w-full items-center justify-between">
        <div className="inline-flex items-center gap-1.5">
          {<column.icon strokeWidth={2.25} className="h-4 w-4" />}
          <span>{column.displayName}</span>
        </div>
        <ArrowRightIcon className="h-4 w-4 opacity-0 group-aria-selected:opacity-100" />
      </div>
    </CommandItem>
  )
}
                ...
                >
                  <div className="flex items-center gap-1.5 group">
                    ...
                    <div className="flex items-center gap-0.5">
                      ...
                      <ChevronRightIcon className="h-3.5 w-3.5 text-muted-foreground/75" />
                      <span>
                        {v.label}
                        <sup
                          className={cn(
